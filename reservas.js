...
function datasValidas(inicio, fim) {
  ...
  if (dInicio < new Date("2026-01-01")) return false;
  if (dFim > new Date("2026-12-31")) return false;
...
function criarReserva(idQuarto, nomeCliente, inicio, fim) {
  if (!datasValidas(inicio, fim)) {
    alert("Datas inválidas (apenas 2026).");
    return;
  }
